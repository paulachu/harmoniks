        ...
        <motion.div
            ...
            <div className="profil_info">
                ...
                <div className="skills">
                    <p className="skills_title"><strong >Skills</strong></p>
            ...
            <div className="profil_info">
                <div className="infos">
                    <p className="single-profile-info">
                        <img width="100px" src="/logos/discord_logo.png"></img>
                        <br/>
                        {user.discord_id}
                    </p>
                    <p className="single-profile-info">
                        <img width="100px" src="/logos/linkedin_logo.png"></img>
                        <br/>
                        {user.linkedin_link}
                    </p>
                    <p className="single-profile-info">
                        <img width="100px" src="/logos/hopper_logo.png"></img>
                        <br/>
                        {user.hopper_link}
                    </p>
                </div>
